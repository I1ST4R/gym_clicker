...
const StoryIntro = ({ onClose }) => {
  ...
  const slides = [
    { 
      image: 'src/assets/StoryIntro/img1.png', 
    ...
    { 
      image: 'src/assets/StoryIntro/img2.jpg', 
    ...
    { 
      image: 'src/assets/StoryIntro/img3.png', 
    ...
    { 
      image: 'src/assets/StoryIntro/img4.png', 
    ...
    { 
      image: 'src/assets/StoryIntro/img5.jpg', 
    ...
    { image: 'src/assets/StoryIntro/img6.png', 
